...
- (void)handleTapGesture:(UITapGestureRecognizer*)tapGesture {
    if([tapGesture state]==UIGestureRecognizerStateRecognized) {
        if(self.delegate && [self.delegate respondsToSelector:@selector(pageScrollView:didTapPageAtIndex:)]) {
            [self.delegate pageScrollView:self didTapPageAtIndex:self.currentPageIndex];
        }
    }
}
